var startingJson = {
  "form_fields": {
    ...
    "notes": {
      "label": "Note pentru curier",
      "required": "false",
      "classes": "col-sm-12 mb-2",
      "placeholder": "Note pentru Curier",
      "type": "textarea"
    }
  },
  "template": {
...
$(document).ready(function($) {
  ...
  htmlResult += "<div id='as_form_error_message' class='w-100 pt-2 pb-2 mt-2 text-center' style='display:none;background-color:#f9fcbb'>"
    + "Te rog verifică câmpurile introduse și încearcă din nou."
    + "</div>";
  ...
  $("#as_submit_order_button").click(function(e) {
    ...
    fetch("https://hook.us2.make.com/xppfil6gfta1mabjtqax668aq8knmzcy", {
      method: "POST",
      headers: {"Content-Type": "application/json"},
      body: JSON.stringify(payload)
    })
