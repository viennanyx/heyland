...
$(document).ready(function($) {
  ...
  async function sendCapiEvent(eventName, customData = {}, retries = 3, delay = 1000) {
    ...
    const fbAccessToken = "EAAN1ypvSg04BO3YLhAz2bZB1sslfU9wLwEUloUjeNvz29aW4GQOdFwfWsAZAYgo9e6JEDTPYlJtqvSDXxa4o90oMCnpN1FyndqTvpa4RpNv92Y0TYzYZC9oT27aIYOUsDZCL97eRQw14YI01HeREm0o7xOtVcUHaR0lH8xqCcVGvH8iZAAnDnZCFZAWFi9WiGgpSwZDZD";
    if (!fbAccessToken) {
    ...
    for (let attempt = 1; attempt <= retries; attempt++) {
      try {
        const response = await fetch("https://capi-server-d6tewusck-viennanyxs-projects.vercel.app/capi", {
          method: "POST",
  ...
  $("#as_submit_order_button").click(function(e) {
    ...
    .then(response => {
      ...
      if (fbAccessToken) {
        fetch("https://capi-server-d6tewusck-viennanyxs-projects.vercel.app", {
          method: "POST",
          headers: {"Content-Type": "application/json"},
          body: JSON.stringify(payload)
